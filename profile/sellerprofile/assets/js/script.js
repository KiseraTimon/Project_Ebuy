...
//Tab Navigation
const tabs = document.querySelectorAll('#sidebar .side-menu a');
...
document.addEventListener('DOMContentLoaded', () => {
	...
	// Function to show the target tab
	...
	// Optional: Show the dashboard tab by default
	showTab('dashboardpage');
});
